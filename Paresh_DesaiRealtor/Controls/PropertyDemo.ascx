 ...
 <script>
     ...
     $(document).ready(function () {
         $("#shareBtn").click(function () {
             ...
             var URL = 'http://victoryrealtors.ca//PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
            ...
            <div class="col-md-12 col-sm-12">
              ...
              <img src="../images/arshad.png" alt="" />
                        ...
                        <div class="roco_pro_info">
                            <h2>
                                <span>Aman Bhandaal & Gurv Dhillon</span>
                            </h2>
                            ...
                            <span class="email_profile_r">416-520-3462 , 416-910-9411</span>
                        </div>
                    </div>
