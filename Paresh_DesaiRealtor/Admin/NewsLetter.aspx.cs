    ...
    public partial class NewsLetter : System.Web.UI.Page
    {
        ...
        protected void FillGridData()
       {
        ...
        public string SendNewsLetter(NewsLetterModel model)
        {
            ...
            {
                model.Logopath = "http://victoryrealtors.ca//images/logo.png";
            }
           

            if (model.PropertyPhoto  == null || model.PropertyPhoto == "")
            {
                model.PropertyPhoto = "http://victoryrealtors.ca//images/img1.png";
            }
        ...
        public void Firstnewsletter(NewsLetterModel Model)
        {
            ...
            //else
            //{
            //    Model.Logopath = "..http://victoryrealtors.ca//images/MyLogodd%20-%20Copy.png";
            //}
